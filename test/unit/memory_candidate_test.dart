...
void main() {
  group('MemoryCandidate Domain Logic', () {
    test('creates candidate from raw text correctly', () {
      final candidate = MemoryCandidate.fromText('Ravi serviced my AC today for Rs. 800.');
      expect(candidate.rawContent, equals('Ravi serviced my AC today for Rs. 800.'));
    ...
    test('updates candidate with structured understanding', () {
      final candidate = MemoryCandidate.fromText('Ravi serviced my AC today for Rs. 800.').withUnderstanding({
        ...
        'summary': 'Ravi from CoolCare serviced the AC for Rs. 800.',
        'people': ['Ravi'],
